    ...
    return (
        <>
          <View style={styles.header}>
            ...
            <Text style={[styles.tabTitle,{opacity:routes ===1 ?  1 :0.5}]} >Completed</Text>

            </TouchableOpacity>
            <TouchableOpacity onPress={()=>setRoutes(2)} style={[styles.tab,{ borderBottomWidth:routes ===2 ? 3 :0}]}>
            <Text style={[styles.tabTitle,{opacity:routes ===2 ?  1 :0.5}]}>Inprogress</Text>

            </TouchableOpacity>
            <TouchableOpacity onPress={()=>setRoutes(3)} style={[styles.tab,{ borderBottomWidth:routes ===3 ? 2:0}]}>
            <Text style={[styles.tabTitle,{opacity:routes ===3 ?  1 :0.5}]}>Not started</Text>
